...
//echo "$name $price $discount $brand $subcategory $description";
//print_r($photo);

$codeno="CODE_".mt_rand(100000,999999);
$basepath="images/items/";//choose image is saved in this path;
$fullpath=$basepath.$photo['name'];
move_uploaded_file($photo['tmp_name'], $fullpath);

$sql="INSERT INTO items (codeno,name,photo,price,discount,description,brand_id,subcategory_id) VALUES(:item_codeno,:item_name,:item_photo,:item_price,:item_discount,:item_des,:item_brand,:item_sub)";
